...
const faqs = [
  ...
  { question: 'What happens after the demo?', answer: 'You can start a 14-day free trial immediately. No credit card required, and you\'ll have full access to all features.' },
      ...
      <main className="pt-24 pb-16 bg-white dark:bg-slate-900 min-h-screen">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-16">
            <div className="bg-slate-900 rounded-2xl aspect-video flex items-center justify-center mb-8 border border-slate-700">
              <div className="text-center">
                ...
                <p className="text-slate-500 text-sm mt-2">Start your free trial to explore the platform</p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16 grid md:grid-cols-2 gap-8">
            <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-8 border border-slate-100 dark:border-slate-700">
              ...
              <Link href="https://app.kontentfire.com/register">
                <Button className="w-full">Start Free Trial <ArrowRight className="ml-2 h-4 w-4" /></Button>
              </Link>
            </div>
          ...
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl p-8 md:p-12 text-center">
            ...
            <Link href="https://app.kontentfire.com/register">
              <Button size="lg">Start Your Free Trial <ArrowRight className="ml-2 h-5 w-5" /></Button>
            </Link>
          </div>
        </div>
      </main>
